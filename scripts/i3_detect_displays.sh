...
if (xrandr | grep 'HDMI-1' | awk '{print $1;}') ; then
    ...
    xrandr --output $LAPTOP_DISPLAY --mode 1920x1080 --pos 2560x0 --rotate normal --output $MAIN_DISPLAY --primary --mode 2560x1080x49.94 --pos 0x0 --rotate normal
else
