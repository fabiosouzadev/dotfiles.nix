  ...
  services.xserver = {
    ...
    windowManager.i3 = {
     ...
     configFile = pkgs.writeText "i3.cfg" ''
        ...
        #exec --no-startup-id sleep 1 && setxkbmap -layout 'us,br' -variant altgr-intl,abnt2 -option 'grp:alt_caps_toggle'
        ...
        #exec --no-startup-id sleep 1 && sh $HOME/.screenlayout/dual_intel_iris_xe.sh

        # set wallpaper
        # exec --no-startup-id sleep 2 && nitrogen --restore
        #exec --no-startup-id sleep 1 && feh --bg-fill /usr/share/endeavouros/backgrounds/eos_wallpapers_community/EOS_SPACEMAN_4K.png

        # https://i.redd.it/j66lclfcc2ca1.png
        #exec --no-startup-id sleep 1 && feh --bg-fill /home/fabio/Pictures/j66lclfcc2ca1.png
        exec --no-startup-id sleep 1 && feh --bg-fill --randomize $HOME/.config/wallpapers

        #exec --no-startup-id sleep 1 && feh --bg-fill $HOME/Pictures/zaki-aby-fisheye-top-0-064.jpg
